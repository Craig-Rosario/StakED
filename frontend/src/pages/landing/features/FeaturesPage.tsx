      ...
      <div className="max-w-7xl mx-auto w-full">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <Card className="p-8 text-center border-4 border-black bg-[#00FF9920] h-full flex flex-col justify-center hover:translate-y-1 transition-transform shadow-[6px_6px_0px_#111]">
